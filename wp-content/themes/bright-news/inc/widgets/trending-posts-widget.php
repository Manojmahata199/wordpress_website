<?php
if ( ! class_exists( 'Bright_News_Trending_Posts_Widget' ) ) {
	/**
	 * Adds Bright_News_Trending_Posts_Widget Widget.
	 */
	class Bright_News_Trending_Posts_Widget extends WP_Widget {
		...
		public function __construct() {
			$bright_news_grid_widget_ops = array(
				...
				'description' => __( 'Retrive Trending Posts Widgets', 'bright-news' ),
			);
			parent::__construct(
				'bright_news_trending_posts_widget',
				__( 'Ascendoor Trending Posts Widget', 'bright-news' ),
