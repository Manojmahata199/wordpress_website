	...
	<div class="bright-news-bottom-footer">
		<div class="section-wrapper">
			<div class="bottom-footer-content">
				<?php
				/**
				 * Hook: bright_news_footer_copyright.
				 *
				 * @hooked - bright_news_output_footer_copyright_content - 10
				 */
				do_action( 'bright_news_footer_copyright' );
				?>
			</div>
		</div>
	</div>
...
<?php
$is_scroll_top_active = get_theme_mod( 'bright_news_scroll_top', true );
