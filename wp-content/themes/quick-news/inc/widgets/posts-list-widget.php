<?php
if ( ! class_exists( 'Quick_News_Posts_List_Widget' ) ) {
	/**
	 * Adds Quick_News_Posts_List_Widget Widget.
	 */
	class Quick_News_Posts_List_Widget extends WP_Widget {

		/**
		 * Register widget with WordPress.
		 */
		public function __construct() {
			$quick_news_list_widget_ops = array(
				'classname'   => 'ascendoor-widget magazine-list-section style-1',
				'description' => __( 'Retrive Posts List Widgets', 'quick-news' ),
			);
			parent::__construct(
				'quick_news_magazine_list_widget',
				__( 'Ascendoor Posts List Widget', 'quick-news' ),
				$quick_news_list_widget_ops
			);
		}
		...
		public function form( $instance ) {
			...
			<p>
				...
				<input class="tiny-text" id="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'number' ) ); ?>" type="number" step="1" min="1" max="4" value="<?php echo absint( $list_post_count ); ?>" size="3" />
			</p>
			<p>
