<?php
if ( ! class_exists( 'Quick_News_Posts_Small_List_Widget' ) ) {
	/**
	 * Adds Quick_News_Posts_Small_List_Widget Widget.
	 */
	class Quick_News_Posts_Small_List_Widget extends WP_Widget {
		...
		public function __construct() {
			...
			parent::__construct(
				'quick_news_magazine_small_list_widget',
				__( 'Ascendoor Posts Small List Widget', 'quick-news' ),
		...
		public function form( $instance ) {
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>"><?php esc_html_e( 'Number of posts to show(Min:1|Max:6):', 'quick-news' ); ?></label>
