...
<body <?php body_class(); ?>>
	...
	<div id="page" class="site">
		<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'newspulse-magazine' ); ?></a>
						...
						if ( ! empty( $advertisement ) ) {
							...
							<div class="mag-adver-part">
								<a href="<?php echo esc_url( $advertisement_url ); ?>">
									<img src="<?php echo esc_url( $advertisement ); ?>" alt="<?php esc_attr_e( 'Advertisment Image', 'newspulse-magazine' ); ?>">
								</a>
							</div>
							<?php
						}
