<?php
if ( ! class_exists( 'Newspulse_Magazine_Posts_Grid_And_List_Widget' ) ) {
	/**
	 * Adds Newspulse_Magazine_Posts_Grid_And_List_Widget Widget.
	 */
	class Newspulse_Magazine_Posts_Grid_And_List_Widget extends WP_Widget {

		/**
		 * Register widget with WordPress.
		 */
		public function __construct() {
			$newspulse_magazine_grid_list_widget_ops = array(
				'classname'   => 'ascendoor-widget magazine-grid-list-section style-1',
				'description' => __( 'Retrive Posts Grid And List Widgets', 'newspulse-magazine' ),
			);
			parent::__construct(
				'newspulse_magazine_magazine_grid_list_widget',
				__( 'Ascendoor Grid And List Widget', 'newspulse-magazine' ),
				$newspulse_magazine_grid_list_widget_ops
			);
		}
