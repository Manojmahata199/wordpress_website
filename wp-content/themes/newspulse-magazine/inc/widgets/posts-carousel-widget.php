<?php
if ( ! class_exists( 'Newspulse_Magazine_Posts_Carousel_Widget' ) ) {
	/**
	 * Adds Newspulse_Magazine_Posts_Carousel_Widget Widget.
	 */
	class Newspulse_Magazine_Posts_Carousel_Widget extends WP_Widget {
		...
		public function __construct() {
			$newspulse_magazine_post_carousel_widget_ops = array(
				'classname'   => 'ascendoor-widget magazine-post-carousel-section',
				'description' => __( 'Retrive Posts Carousel Widgets', 'newspulse-magazine' ),
			);
			parent::__construct(
				'newspulse_magazine_posts_carousel_widget',
				__( 'Ascendoor Posts Carousel Widget', 'newspulse-magazine' ),
				$newspulse_magazine_post_carousel_widget_ops
			);
		}
