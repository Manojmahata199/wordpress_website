<?php
if ( ! class_exists( 'Newspulse_Magazine_Trending_Posts_Carousel_Widget' ) ) {
	/**
	 * Adds Newspulse_Magazine_Trending_Posts_Carousel_Widget Widget.
	 */
	class Newspulse_Magazine_Trending_Posts_Carousel_Widget extends WP_Widget {

		/**
		 * Register widget with WordPress.
		 */
		public function __construct() {
			$newspulse_magazine_trending_carousel_widget_ops = array(
				'classname'   => 'ascendoor-widget magazine-trending-carousel-section',
				'description' => __( 'Retrive Trending Posts Carousel Widgets', 'newspulse-magazine' ),
			);
			parent::__construct(
				'newspulse_magazine_magazine_trending_carousel_widget',
				__( 'Ascendoor Trending Posts Carousel Widget', 'newspulse-magazine' ),
				$newspulse_magazine_trending_carousel_widget_ops
			);
		}
