...
<main id="primary" class="site-main">
	...
	while ( have_posts() ) :
		...
		do_action( 'newspulse_magazine_post_navigation' );

		if ( is_singular( 'post' ) ) {
			$related_posts_label = get_theme_mod( 'newspulse_magazine_post_related_post_label', __( 'Related Posts', 'newspulse-magazine' ) );
			$args                = array(
				'posts_per_page' => 3,
